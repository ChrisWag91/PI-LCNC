...
# Driver functions
    ...
    def preset_PI-LCNC_3axes_outputs(self):
        ...
        # x axis
        self.w.pin3.set_active(index(SIG.XSTEP))
        self.w.pin5.set_active(index(SIG.XDIR))
        self.w.pin8.set_active(index(SIG.AMP))
        # Y axis
        self.w.pin7.set_active(index(SIG.YSTEP))
        self.w.pin29.set_active(index(SIG.YDIR))
        self.w.pin17.set_active(index(SIG.AMP))
        # Z axis
        self.w.pin31.set_active(index(SIG.ZSTEP))
        self.w.pin26.set_active(index(SIG.ZDIR))
        self.w.pin1.set_active(index(SIG.AMP))
        # spindle
        self.w.pin11.set_active(index(SIG.ON))
